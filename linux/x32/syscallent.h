	...
	{ 0,	TS,	sys_rt_sigreturn,	"rt_sigreturn"	},  /* 514 */
	...
	{ 4,	0,	sys_kexec_load,		"kexec_load"	}, /* 530 */
	{ 2,	0,	sys_set_robust_list,	"set_robust_list" }, /* 531 */
	{ 3,	0,	sys_get_robust_list,	"get_robust_list" }, /* 532 */
	{ 4,	TD,	sys_vmsplice,		"vmsplice"	}, /* 533 */
	{ 6,	0,	sys_move_pages,		"move_pages"	}, /* 534 */
	{ 5,	TD,	sys_preadv,		"preadv"	}, /* 535 */
	{ 5,	TD,	sys_pwritev,		"pwritev"	}, /* 536 */
	{ 4,	TP|TS,	sys_rt_tgsigqueueinfo,	"rt_tgsigqueueinfo"}, /* 537 */
	{ 5,	TN,	sys_recvmmsg,		"recvmmsg"	}, /* 538 */
	{ 4,	TN,	sys_sendmmsg,		"sendmmsg"	}, /* 539 */
	{ 6,	0,	sys_process_vm_readv,	"process_vm_readv"	}, /* 540 */
	{ 6,	0,	printargs,		"process_vm_writev"	}, /* 541 */
